...
function recapiti() {
    ...
    echo("<strong>Telefono:</strong> +39 3480349156<br><br>");
    echo("Indirizzo <strong>e-mail:</strong> matteo-malandrino@gmail.com<br><br><hr><br><br>");
}
function form() {
   echo "<h1 id='informazioni'>Form per richiesta informazioni</h1> 
...
<div id="nav"><?php link4() ?></div>
<h1 id="Contatti">Contatti</h1>
<div id="mappa-e-contatti">
<p>Ecco a voi una <strong>mappa</strong> per la mia <strong>sede legale:</strong><br><br>
